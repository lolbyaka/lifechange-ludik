...
export function ExchangeForm({
  ...
  return (
    ...
    >
      ...
      <div>
        <label htmlFor="secretKey" className="block text-sm font-medium text-slate-400">
          Secret Key
        </label>
        <input
          id="secretKey"
      ...
      <div>
        <label htmlFor="passphrase" className="block text-sm font-medium text-slate-400">
      ...
      <div>
        <label htmlFor="walletAddress" className="block text-sm font-medium text-slate-400">
